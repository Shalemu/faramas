...
class ApiConstants {
  ...
  static const String updatephone = '$baseUrl/auth/update-phone'; //update phone-number
  static const String otpRequest = '$baseUrl/auth/otp/request/';
  static const String register = '$baseUrl/api/user-registration/';
  static const String resetPassword =
    '$baseUrl/auth/reset/user-password';
    static const String requestResetToken =
    '$baseUrl/auth/request/reset-token';
    static const String changePassword =
    '$baseUrl/auth/user-change-password';
  ...
  static const String getAirbnbProperties = '$baseUrl/api/properties/?category=Airbnb';
  static const String postAirbnbProperties = '$baseUrl/api/properties/'; // Same endpoint, differentiated by category field
...
static const String myPayments =
    '$baseUrl/api/payments/my-payments/';
  

  //tour
  static const String tourRequests = '$baseUrl/api/tour-requests/';
  static const String confirmTourRequest =
    '$baseUrl/api/confirm-tour-request/';
